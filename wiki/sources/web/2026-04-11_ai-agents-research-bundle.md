...
used_for: Part 6 AI Agents 실전 (Ch.01-10 전반)
---
...
Part 6 AI Agents 실전 합성 사이클(LLM Wiki 사이클 #1)에서 사용된 WebSearch 결과 bundle. **LangChain State of Agent Engineering 2026**는 중요성이 커서 별도 파일로도 기록 ([여기](./2026-04-12_langchain-state-of-agent-engineering.md)).
...
Part 6 전 10 챕터 (Ch.01 Production Gap부터 Ch.10 프레임워크 카탈로그까지).

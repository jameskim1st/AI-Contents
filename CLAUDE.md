...
- Part 0: `var(--violet)` / `--violet-bg` / `--violet-border`
- Part 1·4 (Data): `var(--amber)` / `--amber-bg` / `--amber-border`
- Part 2 (AI Agents 기초): `var(--teal)` / `--teal-bg` / `--teal-border`
- Part 3 (AI Agents 실전): `var(--violet)` 계열
- Part 5·6 (Vibe): `var(--accent)` / `--accent-bg` / `--accent-border`
- Part 7 (Power Platform): `var(--blue)` / `--blue-bg` / `--blue-border`

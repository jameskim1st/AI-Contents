...
**메타:** 이 파일 자체가 Part 8 Ch.05 "Harness Engineering"과 Ch.09 "LLM Wiki"에서
가르치는 패턴의 살아있는 적용입니다.
...
| 6 | `/06-it-basics` | green | 개발 배경지식 — IT 기초 |
| 7 | `/07-vibe-basic` | accent (orange) | 바이브코딩 입문 |
| 8 | `/08-vibe-master` | accent (orange) | 바이브코딩 심화 |
| 9 | `/09-power-platform` | blue | Power Platform |
...
- Part 6 (IT 기초): `var(--green)` / `--green-bg` / `--green-border`
- Part 7·8 (Vibe): `var(--accent)` / `--accent-bg` / `--accent-border`
- Part 9 (Power Platform): `var(--blue)` / `--blue-bg` / `--blue-border`
...
- **링크는 Vercel 배포 URL** 사용:
  ```
  ✓ https://ai-contents-wine.vercel.app/02-data-basics/#anchor
...
자세히는 `wiki/schema.md`와 [Part 8 Ch.09 LLM Wiki](https://ai-contents-wine.vercel.app/08-vibe-master/#vm-ch9).
...
- **본 사이트가 LLM Wiki를 직접 운영하는 살아있는 데모:** [Part 8 Ch.09](https://ai-contents-wine.vercel.app/08-vibe-master/#vm-ch9)
